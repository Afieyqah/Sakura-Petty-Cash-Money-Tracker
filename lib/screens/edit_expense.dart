...
class _EditExpenseScreenState extends State<EditExpenseScreen> {
      ...
      if (doc.exists) {
        ...
        setState(() {
          ...
          if (data['payment_method'] != null &&
              _paymentMethods.contains(data['payment_method'])) {
  ...
  Future<void> _updateExpense() async {
    ...
    if (_isCustomUnit && customUnit.isEmpty) {
      _showNotification("⚠️ Please enter a custom unit name", Colors.orange);
      return;
    }
      ...
      try {
        ...
        if (mounted) {
          ...
          Navigator.of(context)
            ..pop()
            ..pop(); // Go back twice to return to list
        }
      } catch (e) {
